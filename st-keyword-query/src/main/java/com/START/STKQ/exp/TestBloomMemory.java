...
//                        if (!textHash.containsKey(s)) {
//                            textHash.put(s, textID++);
//                        }
//                    }
//
//                    byte[] sCode = sKeyGenerator.toKey(new Location(lat, lon));
//                    byte[] tCode = tKeyGenerator.toKey(date);
//                    for (String s : keywords) {
//                        byte[] textCode = ByteUtil.getKByte(textHash.get(s), 3);
//                        Put put = new Put(ByteUtil.concat(textCode, sCode, tCode));
